...
*/
	...
	*/
	...
	try {
		...
		JobDetail job = new JobDetail(vo.getJobName(), vo.getJobGroup(), cl);
	...
	try {
		...
		b = scheduler.deleteJob(vo.getJobName(), vo.getJobGroup());
	...
	boolean b = false;
	try {
		b = scheduler.interrupt(jobName, jobGroup);
